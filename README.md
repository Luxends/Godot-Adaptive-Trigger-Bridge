...
The file [`TriggerEffectDemo.gd`](./TriggerEffectDemo.gd) demonstrates a production-ready usage pattern, including **software hysteresis** to filter haptic noise and **state-check optimization** to reduce USB bus traffic.
